...
The types of files you should consider adding to a .gitignore file are any files that do not need to get committed. Any file that can be regenerated doesn't require to be committed in github. for example, For security, the security key files and API keys should get added to the gitignore.
